...
const SectionNavbarBase = ({
  ...
  <div
    className={`sticky z-10 ${
      vertical ? 'top-5 basis-1/4 md:basis-2/12' : 'top-0 w-full bg-white '
    }`}
  >
    <text className="text-4xl font-bold pl-36">Companies</text>
    <nav
      className={`gap-4 text-md text-muted-foreground border-b md:border-0 text-left md:text-left ${
        vertical ? 'grid' : 'flex flex-row justify-left pl-36 pt-5'
      }`}
    >
