...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'ay-fixed ay-inset-0 ay-z-50 ay-bg-black/80 data-[state=open]:ay-animate-in data-[state=closed]:ay-animate-out data-[state=closed]:ay-fade-out-0 data-[state=open]:ay-fade-in-0',
      className
    )}
    {...props}
    ref={ref}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn('ay-text-lg ay-font-semibold', className)}
    {...props}
  />
));
