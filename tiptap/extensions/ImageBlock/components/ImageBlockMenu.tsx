...
import { MenuProps } from '@tiptap-location/components/menus/types';
import { getRenderContainer } from '@tiptap-location/lib/utils';
    ...
    >
      <Toolbar.Wrapper shouldShowContent={shouldShow()} ref={menuRef}>
        ...
        <ImageBlockWidth
          ...
          value={parseInt(editor.getAttributes('imageBlock').width, 10)}
        />
      </Toolbar.Wrapper>
    </BaseBubbleMenu>
  );
